export const abi = [
  ...
  { inputs: [], name: "ContractAlreadyRegistered", type: "error" },
  { inputs: [], name: "ContractNotFound", type: "error" },
  { inputs: [], name: "ContractPaused", type: "error" },
  { inputs: [], name: "ExistingContractNotRegistered", type: "error" },
  ...
  { inputs: [], name: "ValueNotWithinRange", type: "error" },
  {
    inputs: [
  ...
  },
  {
    inputs: [
      { internalType: "string", name: "contractName", type: "string" },
      { internalType: "address", name: "existingAddr", type: "address" },
